...
const overlay = Buffer.from(`<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="72" y="235" fill="#56d8d0" font-family="Arial, sans-serif" font-size="20" font-weight="700" letter-spacing="4">ISARKLIMA · DEUTSCHLANDWEIT</text>
  <text x="72" y="330" fill="#ffffff" font-family="Arial, sans-serif" font-size="60" font-weight="800">Klimaanlagen planen</text>
  <text x="72" y="405" fill="#ffffff" font-family="Arial, sans-serif" font-size="60" font-weight="800">und installieren lassen</text>
...
await sharp(hero)
  ...
  .toFile(join(ogDir, 'isarklima-deutschland.jpg'));
